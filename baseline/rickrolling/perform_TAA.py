...
def main():
    ...
    for step in tqdm(range(config.num_steps), desc="Training", unit="step"):
        ...
        backdoor_losses = []
        for backdoor in tqdm(config.backdoors):
        ...
        tqdm.write(f"Step {step}: benign={loss_benign:.4f}, backdoor={loss_backdoor:.4f}, total={loss_total:.4f}")
